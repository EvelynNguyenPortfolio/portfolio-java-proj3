...
public class Driver
{
    ...
    //execute findPassenger method (extra credit option)
...
/*
"C:\Program Files\Java\jdk-20\bin\java.exe" "-javaagent:C:\Program Files\JetBrains\IntelliJ IDEA 2023.2.1\lib\idea_rt.jar=58421:C:\Program Files\JetBrains\IntelliJ IDEA 2023.2.1\bin" -Dfile.encoding=UTF-8 -Dsun.stdout.encoding=UTF-8 -Dsun.stderr.encoding=UTF-8 -classpath C:\Users\enngu\IdeaProjects\CSC120\out\production\CSC121 Project1.Driver
...
2
Please enter the seat you would like to reserve.
A
Please enter the seat type you want.
extra_legroom
...
Please enter the seat type you want.
extra_legroom
Success! Seat: 2B has been reserved.
...
5 - Exit
2
1A Passenger Name: Abigail Jones
   Seat Type: EXTRA_LEGROOM
1B Passenger Name: Daniel Jones
   Seat Type: EXTRA_LEGROOM
2A Passenger Name: Sally McConnell
   Seat Type: STANDARD
2B Passenger Name: Evelyn Nguyen
   Seat Type: EXTRA_LEGROOM
3A Passenger Name: Joseph Rogers
   Seat Type: STANDARD
3C Passenger Name: Vincent Potters
   Seat Type: EXTRA_LEGROOM
4A Passenger Name: Elizabeth Stone
   Seat Type: STANDARD
...
5 - Exit
4
Please enter the name of the passenger you want to find
John Smith
...
Please enter the seat type you want.
extra_legroom
Success! Seat: 2C has been reserved.
...
2B Passenger Name: Evelyn Nguyen
   Seat Type: EXTRA_LEGROOM
2C Passenger Name: Christian Nguyen
   Seat Type: EXTRA_LEGROOM
3A Passenger Name: Joseph Rogers
   Seat Type: STANDARD
3C Passenger Name: Vincent Potters
